...
import com.karashok.library.common.databinding.recycler_view.BaseRecyclerViewAdapter;
import com.karashok.library.common.databinding.view_pager.BindingViewPagerAdapter;
 ...
 * DESCRIPTION Base interface for the binding collection adapters for various components.
 * @see BaseRecyclerViewAdapter
 * @see BindingViewPagerAdapter
 * @date 2018/06/16/下午6:18
 */
public interface BindingCollection<T> {
     ...
     */
    ViewDataBinding initBinding(LayoutInflater inflater, @LayoutRes int layoutRes, ViewGroup viewGroup);
