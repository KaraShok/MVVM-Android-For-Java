package com.karashok.library.common.databinding.base.collection;
...
public class MergeObservableList<T> extends AbstractList<T> implements ObservableList<T> {
    ...
    private final MergeObservableList.ListChangeCallback callback = new MergeObservableList.ListChangeCallback();
