...
import com.karashok.mvvm.main.widget.DragPhotoView;


public class ImagePreviewActivity_2 extends AppCompatActivity {

    private PhotoViewPager view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = findViewById(R.id.photo_view_pager);

        mPhotoViews = new DragPhotoView[count];
