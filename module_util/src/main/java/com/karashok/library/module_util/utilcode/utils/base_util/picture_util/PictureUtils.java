...
import com.karashok.library.module_util.utilcode.utils.base_util.file_util.FileTool;
...
public final class PictureUtils {
     ...
     * @param path
     */
    public static void refreshSystemAlbum(Activity activity, String path) {
        //将图片加入系统相册中
     ...
     * @param uri
     */
    public static void takePicture(Activity activity, Uri uri, @NonNull int code) {
