...
public final class NetworkUtils {
    ...
    public static boolean isAvailableByPing(String ip) {
        ...
        if (result.errorMsg != null) {
            LogUtils.dTag("NetworkUtils", "isAvailableByPing() called" + result.errorMsg);
        }
        if (result.successMsg != null) {
            LogUtils.dTag("NetworkUtils", "isAvailableByPing() called" + result.successMsg);
        }
        return ret;
    }
