...
public class FragmentUtils {
    ...
    /**
     * 显示 Fragment 和隐藏 Fragment ，并带有动画
     * <p>
     * @param show      准备显示的 Fragment
     * @param hide      准备隐藏的 Fragment
     * @param enterAnim 显示 Fragment 的进入动画
     * @param exitAnim  隐藏 Fragment 的退出动画
     * </p>
     */
    public static void showHideWithAnim(@NonNull final Fragment show,
                                        @NonNull final Fragment hide,
                                        @AnimRes final int enterAnim,
                                        @AnimRes final int exitAnim) {
        putArgs(show, false);
        putArgs(hide, true);
        operateWithAnim(show.getFragmentManager(), TYPE_SHOW_HIDE_FRAGMENT, exitAnim, exitAnim, show, hide);
     ...
     * @param enterAnim 显示 Fragment 的进入动画
     * @param exitAnim  隐藏 Fragment 的退出动画
     * @param src       准备显示的 Fragment
     * @param dest      准备隐藏的 Fragment
     */
    private static void operateWithAnim(final FragmentManager fm,
                                        final int type,
                                        @AnimRes final int enterAnim,
                                        @AnimRes final int exitAnim,
                                        final Fragment src,
    ...
    private static void operate(final int type,
        ...
        if (src != null && src.isRemoving()) {
            LogUtils.eTag("FragmentUtils", src.getClass().getName() + " is isRemoving");
            return;
        }
        String name;
        Bundle args;
