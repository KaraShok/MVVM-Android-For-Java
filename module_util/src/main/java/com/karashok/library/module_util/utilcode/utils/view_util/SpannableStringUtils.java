 ...
 * @name SpannableStringUtils
 * DESCRIPTION SpannableString相关
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    ...
                    LogUtils.eTag("sms", "Failed to loaded content " + mContentUri, e);
                }
            } else {
                try {
                    ...
                    LogUtils.eTag("sms", "Unable to find resource: " + mResourceId);
                }
            }
            return drawable;
        }
