...
import com.karashok.library.module_util.utilcode.utils.base_util.CleanUtils;
...
import com.karashok.library.module_util.utilcode.utils.device_util.ShellUtils;
...
public class AppUtils {
    ...
    public static boolean isAppRoot() {
        ...
        if (result.errorMsg != null) {
            LogUtils.dTag("AppUtils","isAppRoot() called" + result.errorMsg);
        }
        return false;
    }
    ...
    public static boolean cleanAppData(final File... dirs) {
        ...
        for (File dir : dirs) {
            isSuccess &= CleanUtils.cleanCustomDir(dir);
        }
        return isSuccess;
    }
