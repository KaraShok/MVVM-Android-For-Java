 ...
 * DESCRIPTION
 * @name ImageLoaderOptions
 * @date 2018/05/19 下午1:47
 **/
public class ImageLoaderOptions {
    ...
    public final static class Builder {
        ...
        private ImageView mViewContainer;  // 图片容器
        private String url;  // 图片地址
        ...
        public Builder(@NonNull ImageView v, @NonNull String url) {
            this.url = url;
            this.mViewContainer = v;
        }

        public Builder(@NonNull ImageView v, @NonNull int resource) {
